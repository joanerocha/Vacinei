...
/**
 * Created by Joane Rocha on 17/08/2017.
 */
...
public class Validacao {
    ...
    public final static boolean validateEmail(String txtEmail) { // Valida Email
    ...
    public final static boolean validateSUS(String s) {
    ...
    private final static int somaPonderada(String s) {
